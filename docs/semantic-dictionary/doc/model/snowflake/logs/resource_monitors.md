<!-- model snowflake.logs.resource_monitors -->
<!-- The content between the markdown start and end comments (tags) is generated. Please do not edit manually. -->
## Snowflake resource monitors log records

Log records emitted by the DSOA resource_monitors plugin.

### Query

Fetch the 100 most recent DSOA resource_monitors plugin log entries from Grail.

*Davis CoPilot description: Search for all resource_monitors plugin logs from the Snowflake observability agent.*
...
*Davis CoPilot description: Show recent Snowflake resource monitor credit quota consumption.*
...
*Davis CoPilot description: Find Snowflake resource monitors close to exhausting their credit quota.*
...
Snowflake resource monitors log records implements the following interfaces: *i.dsoa_resource*
