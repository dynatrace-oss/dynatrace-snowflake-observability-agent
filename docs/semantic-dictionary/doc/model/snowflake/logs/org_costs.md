<!-- model snowflake.logs.org_costs -->
<!-- The content between the markdown start and end comments (tags) is generated. Please do not edit manually. -->
## Snowflake org costs log records

Log records emitted by the DSOA org_costs plugin.

### Query

Fetch the 100 most recent DSOA org_costs plugin log entries from Grail.

*Davis CoPilot description: Search for all org_costs plugin logs from the Snowflake observability agent.*
...
*Davis CoPilot description: Show recent Snowflake organisation credit and billing figures per account.*
...
*Davis CoPilot description: Find which Snowflake accounts have the highest organisation billing amount.*
...
Snowflake org costs log records implements the following interfaces: *i.dsoa_resource*
