<!-- model snowflake.logs.metering -->
<!-- The content between the markdown start and end comments (tags) is generated. Please do not edit manually. -->
## Snowflake metering log records

Log records emitted by the DSOA metering plugin.

### Query

Fetch the 100 most recent DSOA metering plugin log entries from Grail.

*Davis CoPilot description: Search for all metering plugin logs from the Snowflake observability agent.*
...
*Davis CoPilot description: Show recent Snowflake per-service credit consumption from the metering plugin.*
...
*Davis CoPilot description: Find which Snowflake services consume the most metered credits.*
...
Snowflake metering log records implements the following interfaces: *i.dsoa_resource*
