...
| [Data Volume Anomaly Detection](./data-volume-anomaly/readme.md)              | Quality               | Detects table row-count spikes (bulk loads, duplication) and drops (failed pipelines, deletes) | `data_volume`       |
