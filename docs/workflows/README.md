...
|---------------------------------------------------------------------------------------------------|-----------------------|------------------------------------------------------------------------------------------------|----------------------------------|
| [Security Anomaly Detection](./security-anomaly-detection/readme.md)                              | Security              | Detects abnormal login patterns, session counts, query volumes, and data scans per user/table  | `login_history`, `query_history` |
...
| [Broken Share Detection](./shares-broken-detection/readme.md)                                     | Quality / Security    | Detects broken, disappeared, or degraded inbound Snowflake shares                              | `shares`                         |
...
| [Query Slowdown Detection](./query-slowdown-detection/readme.md)                                  | Performance           | Detects abnormal increases in average query execution time per warehouse and database          | `query_history`                  |
...
| [Warehouse Sensitive Change Alert *(Experimental)*](./warehouse-sensitive-change-alert/readme.md) | Security              | Alerts when a sensitive warehouse or resource-monitor property is altered via DDL              | `query_history`                  |
