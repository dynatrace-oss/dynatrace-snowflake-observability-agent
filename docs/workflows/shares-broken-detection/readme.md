...
Complements the [Snowflake Shares & Governance](../../dashboards/snowflake-shares-governance/readme.md) dashboard.
...
- **`snowflake.data.rows` is a string attribute** on `inbound_shares` logs (not a native metric).
  ...
  See the [Snowflake Shares & Governance known limitations](../../dashboards/snowflake-shares-governance/readme.md).
