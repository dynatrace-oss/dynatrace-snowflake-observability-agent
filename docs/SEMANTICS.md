...
| deployment.&#8203;environment            | The DSOA deployment identifier used to differentiate Snowflake accounts / monitoring environment configurations, when reporting to the same Dynatrace tenant or from the same Snowflake account. Configured via 'core.snowflake.deployment_environment'.                                                                                                                                                                                                                                                                        | PROD                                   | deprecated |
...
| snowflake.&#8203;warehouse.&#8203;owner.&#8203;role                 | The role type of the warehouse owner.                                                                                                                                                                                        | ROLE                           | stable    |
