...
| session.&#8203;id                                       | The unique identifier for the session in which the query was executed.                           | 123456789                            | experimental |
...
| Identifier                                            | Description                                                                                                             | Example                       | Stability | Context Name |
|-------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|-------------------------------|-----------|--------------|
| snowflake.&#8203;budget.&#8203;owner                  | The owner of the budget, typically the user or role responsible for managing the budget.                                | budget_admin                  | stable    | budgets      |
...
| session.&#8203;id                             | The unique identifier for the session.                                                              | 1234567890                                                 | experimental | sessions                |
...
| status.&#8203;code                            | The outcome status of an operation.                                                                 | OK                                                         |              | login_history           |
| status.&#8203;message                         | A human<br>-readable message providing additional detail about the operation status.                | Login successful                                           |              | login_history           |
...
| plugins.&#8203;query_history.&#8203;obfuscation_mode                      | Configuration key controlling query text obfuscation mode applied to `db.query.text` and `snowflake.error.message`. Possible values: `off` (no transformation), `literals` (replace string and numeric literals with `?`), `full` (replace entire query text with `[OBFUSCATED]`).                                                                                                                                                                                                                                                                                                                                                                                                                        | off                                                                                                                                                                   | stable       |
...
| session.&#8203;id                                                         | The session ID during which the query was executed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 1234567890                                                                                                                                                            | experimental |
...
| snowflake.&#8203;warehouse.&#8203;owner.&#8203;role_type            | The role type of the warehouse owner.                                                                                                                                                                                        | SYSADMIN                       | stable    |
...
| snowflake.&#8203;warehouses.&#8203;names                            | The names of the warehouses monitored.                                                                                                                                                                                       | ['COMPUTE_WH', 'ETL_WH']       |           |
...
| snowflake.&#8203;user.&#8203;privilege                          | Name of the privilege and type of object this privilege granted on to the user or role. Composed as `privilege:granted_on_object`.              | CREATE SERVICE:SCHEMA                          | stable    | users_all_privileges                |
...
| snowflake.&#8203;user.&#8203;roles.&#8203;direct                | List of all direct roles granted to user.                                                                                                       | [['DEVOPS_ROLE', 'SYSADMIN', 'ACCOUNTADMIN']]  | stable    | users_direct_roles                  |
