...
EOSQL
    echo "-- Admin objects (DTAGENT_ADMIN)" > build/80_admin.sql
...
teardown() {
    ...
    rm -rf build/05_admin_init.sql build/80_admin.sql build/20_setup.sql build/40_config.sql build/70_agents.sql build/30_plugins
