...
create or replace procedure DTAGENT_DB.CONFIG.UPDATE_EVENT_LOG_CONF()
returns text
language SQL
execute as caller
as
...
grant usage on procedure DTAGENT_DB.CONFIG.UPDATE_EVENT_LOG_CONF() to role DTAGENT_VIEWER;

-- call DTAGENT_DB.CONFIG.UPDATE_EVENT_LOG_CONF();